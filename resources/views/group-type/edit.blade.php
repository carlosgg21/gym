    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
            ...
            <li class="breadcrumb-item active">Modificar Tipo de Grupo</li>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('group-types.update',$groupType->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="InputTipo"  name="type" placeholder="Tipo de empleado" value="{{ $groupType->type }}"  required>
