    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
            ...
            <li class="breadcrumb-item active">Modificar Propietario</li>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('owners.update',$owner->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="InputFullName"  name="full_name" value="{{ $owner->full_name }}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control form-control-sm" id="InputEmail"  name="email" value="{{ $owner->email }}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" min="8" class="form-control form-control-sm" id="InputTelf"  name="cellphone" value="{{ $owner->cellphone }}" >
